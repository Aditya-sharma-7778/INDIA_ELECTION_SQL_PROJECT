--PROJECT ON THE BASIS OF INDIA_ELECTION_2024
--NDIA GENERAL ELECTIONS RESULT ANALYSIS 2024

--STEP1=CREATE TABLE FOR 5 TYPES OF DETAIL WE HAVE
...
SELECT 
    SUM(CASE 
            ...
            ELSE 0 END) AS NDA_Total_Seats_Won
FROM 
    partywise_results;
